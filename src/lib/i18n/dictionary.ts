...
const en: Dictionary = {
  ...
  footer: {
    tagline: "Ayodhya, Uttar Pradesh · Standing in for the families who cannot come",
  ...
  home: {
    heroEyebrow: "Ayodhya-Verified Pandits · Online Now", heroHindiLine: "श्री राम की नगरी से — आपके घर तक",
    heroTitleLine1: "Ayodhya is far.", heroTitleLine2: "Your prayer is not.",
    heroTagline: "Not everyone can stand at the temple themselves — work, distance, age, visas. So a verified Ayodhya pandit performs the puja in your name, and the prasad reaches your door. Your kundali is free, and every astrologer here shows their credentials before you pay a rupee.",
...
const hi: Dictionary = {
  ...
  footer: {
    tagline: "अयोध्या, उत्तर प्रदेश · उन परिवारों के लिए, जो स्वयं नहीं आ सकते",
  ...
  home: {
    heroEyebrow: "अयोध्या-सत्यापित पंडित · अभी ऑनलाइन", heroHindiLine: "श्री राम की नगरी से — आपके घर तक",
    heroTitleLine1: "अयोध्या दूर है।", heroTitleLine2: "आपकी प्रार्थना नहीं।",
    heroTagline: "हर कोई स्वयं मंदिर तक नहीं पहुँच पाता — काम, दूरी, उम्र। इसलिए अयोध्या का सत्यापित पंडित आपके नाम से संकल्प लेकर पूजा करता है, और प्रसाद आपके घर तक पहुँचता है। कुंडली नि:शुल्क है, और हर ज्योतिषी अपनी योग्यता पहले दिखाता है।",
